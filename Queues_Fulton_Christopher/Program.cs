...
namespace Queues_Fulton_Christopher
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Player p1 = new Player(100, "Yung_Modi");
            Player p2 = new Player(100, "Zilla");
            Player p3 = new Player(100, "Sanray");
            Player p4 = new Player(100, "Giggy6161");
